    ...
    setTimeout(function(){
      $.ajax(ajaxurl, {
          ...
          'success': function(){
            ...
            var success_message = $("<span class='savedsettings'>Settings saved</span>");
            save_status.empty();
          ...
          'error': function(){
            save_status.empty();
            save_status.append("<span class='error_savedsettings'>Error saving settings, please retry</span>");
            save_button.removeAttr('disabled');
          }
      }); }, 400); 
  });
